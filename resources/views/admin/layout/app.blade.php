...
<head>
    ...
    <title>AvisoWellness</title>
    <meta name="description" content="Sufee Admin - HTML5 Admin Template">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <script>window.Laravel = { csrfToken: '{{ csrf_token() }}' } </script>
    <link rel="stylesheet" type="text/css" href="{{url('admin/assets/css/normalize.css')}}"/>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('admin/assets/css/themify-icons.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{url('admin/assets/css/flag-icon.min.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{url('admin/assets/css/cs-skin-elastic.css')}}"/>
    <link rel="stylesheet" type="text/css" href="{{url('admin/assets/scss/style.css')}}"/>
...
<body>
    ...
    <script src = "{{url('admin/assets/js/vendor/jquery-2.1.4.min.js')}}" type="text/javascript" ></script>
